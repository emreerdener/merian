...
1. Create a new file `apps/ios/Merian/Models/Schema/SchemaV27.swift`.
...
1. Update `apps/ios/Merian/Models/Aliases.swift`:
```diff
...
1. Open `apps/ios/Merian/Models/SchemaVersions.swift`.
