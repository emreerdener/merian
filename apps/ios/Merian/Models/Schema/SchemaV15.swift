...
enum MerianSchemaV15: VersionedSchema {
    ...
    static var models: [any PersistentModel.Type] {
        ...
        [MerianSchemaV15.LocalScanRecord.self, MerianSchemaV15.OfflineQueuedScan.self,
         MerianSchemaV15.ScanCollection.self, MerianSchemaV15.PendingCloudDeletionTask.self]
    }
