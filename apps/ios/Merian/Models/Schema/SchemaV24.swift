...
enum MerianSchemaV24: VersionedSchema {
    ...
    static var models: [any PersistentModel.Type] {
        ...
        [MerianSchemaV24.LocalScanRecord.self, MerianSchemaV24.OfflineQueuedScan.self,
         MerianSchemaV24.ScanCollection.self, MerianSchemaV24.PendingCloudDeletionTask.self]
    }
