...
// Changed: added gbifTaxonKey: Int? for GBIF occurrence heatmap overlay support
enum MerianSchemaV18: VersionedSchema {
    ...
    // ScanCollection redeclared so its inverse relationship points to V18.LocalScanRecord.
    @Model
