...
//
// MARK: - Frozen LocalScanRecord snapshot for MerianSchemaV30
// Generated from ActiveSchema before isFlagged was added.
...
enum MerianSchemaV30: VersionedSchema {
    ...
    static var models: [any PersistentModel.Type] {
        [MerianSchemaV30.LocalScanRecord.self, MerianSchemaV30.OfflineQueuedScan.self,
         MerianSchemaV30.ScanCollection.self, MerianSchemaV30.PendingCloudDeletionTask.self]
    }

    typealias OfflineQueuedScan        = MerianSchemaV29.OfflineQueuedScan
    typealias PendingCloudDeletionTask = MerianSchemaV29.PendingCloudDeletionTask

    // ScanCollection redeclared so its inverse relationship points to V30.LocalScanRecord.
    @Model
