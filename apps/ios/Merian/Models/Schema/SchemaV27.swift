...
//
// MARK: - Frozen LocalScanRecord snapshot for MerianSchemaV27
// Generated by: python3 .agents/workflows/freeze_schema.py 27
// Captures the LocalScanRecord shape AT V27 — before candidatesData was added.
...
enum MerianSchemaV27: VersionedSchema {
    ...
    static var models: [any PersistentModel.Type] {
        [MerianSchemaV27.LocalScanRecord.self, MerianSchemaV27.OfflineQueuedScan.self,
         MerianSchemaV27.ScanCollection.self, MerianSchemaV27.PendingCloudDeletionTask.self]
    }

    typealias OfflineQueuedScan        = MerianSchemaV26.OfflineQueuedScan
    typealias PendingCloudDeletionTask = MerianSchemaV26.PendingCloudDeletionTask

    // ScanCollection redeclared so its inverse relationship points to V27.LocalScanRecord.
    @Model
