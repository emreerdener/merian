...
// Frozen from the V49 source parent at cff7f39e. These types are the immutable
// source side of V49 -> V50 and must never follow active schema edits. A genuine
// released-binary install-over remains the external compatibility proof.
extension MerianSchemaV49 {
    ...
    final class LocalScanRecord {
        ...
        var capturedMediaEntries: [MerianSchemaV49.CapturedMediaEntry]? = []
        ...
        var collections: [MerianSchemaV49.ScanCollection]? = []
        ...
        init(
            ...
            collections: [MerianSchemaV49.ScanCollection]? = [],
    ...
    final class ScanCollection {
        ...
        var scans: [MerianSchemaV49.LocalScanRecord]? = []
        ...
        init(
            ...
            scans: [MerianSchemaV49.LocalScanRecord]? = []
        ) {
            self.id = id
            self.name = name
