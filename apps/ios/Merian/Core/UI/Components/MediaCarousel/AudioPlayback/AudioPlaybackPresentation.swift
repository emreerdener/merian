...
struct AudioPlaybackPresentation {
    ...
    let boostPillState: AudioBoostPillState?
    ...
    init(
        ...
        isControlPresented = AudioPlaybackControlPolicy.shouldPresent(
            isVisible: isControlVisible,
            isSeeking: isSeeking
        )
        isControlDisabled = AudioPlaybackControlPolicy.shouldDisable(
        ...
        accessibilityValue = duration > 0
            ...
            : "Unavailable"
        boostPillState = AudioBoostPillState.resolve(
    ...
    private static func format(_ seconds: TimeInterval) -> String {
        AudioPlaybackTimeFormatter.string(from: seconds)
    }
}
