...
export const metadata: Metadata = {
  ...
  description: "How to manage privacy choices, exports, and deletion requests in Naturebook."
};
    ...
    >
      <LegalSection title="In-App Controls">
        <LegalList>
          ...
          <li>Exclude Location in Photos&apos; share Options before sending a photo to Naturebook.</li>
          <li>Use Naturebook geoprivacy settings to choose open, obscured, or private location sharing behavior.</li>
          ...
          <li>Use account deletion in Naturebook settings to request removal of your account and associated cloud data.</li>
        </LegalList>
      </LegalSection>

      <LegalSection title="Data Export">
        <Text>
          Naturebook can generate a Darwin Core Archive export for research-friendly access to
      ...
      <LegalSection title="Public Content">
        <Text>
          ...
          already shared outside Naturebook may remain wherever recipients saved, cached, or
          reposted them.
        </Text>
      </LegalSection>
    </LegalPage>
