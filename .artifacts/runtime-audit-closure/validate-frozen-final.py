...
print("Waiting for an idle Xcode runner",flush=True)
while subprocess.run(["pgrep","-x","xcodebuild"],stdout=subprocess.DEVNULL).returncode==0:
 time.sleep(5)
root=pathlib.Path('/Users/emreerdener/Developer/merian/.artifacts/runtime-audit-closure/candidate');out=root.parent/'frozen-final'
