...
status=run_when_idle('audit --destination "platform=iOS Simulator,id=33E6776C-4639-4EE9-BDB6-994A3941FEE6" --environment-label "MacBookPro18-1-iOS27-continuation"','audit.log')
