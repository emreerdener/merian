...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_species_dict_scientific_name ON public.species_dictionary (scientific_name);
...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_scans_discovery_feed ON public.scans (geoprivacy, is_live_capture, timestamp DESC);
