CREATE TABLE IF NOT EXISTS public.explore_comment_reactions (
...
CREATE INDEX IF NOT EXISTS idx_explore_comment_reactions_comment_id ON public.explore_comment_reactions(comment_id);
