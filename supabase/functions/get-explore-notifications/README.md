...
```sh
deno fmt --check supabase/functions/get-explore-notifications
deno lint supabase/functions/get-explore-notifications
deno check supabase/functions/get-explore-notifications/index.ts
deno test --allow-env --allow-net supabase/functions/_tests/exploreNotificationsDb.test.ts
```
