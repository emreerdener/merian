...
```sh
deno fmt --check supabase/functions/get-explore-author-posts
deno lint supabase/functions/get-explore-author-posts
deno check supabase/functions/get-explore-author-posts/index.ts
