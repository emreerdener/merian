...
```sh
deno fmt --check supabase/functions/get-explore-author-profile
deno lint supabase/functions/get-explore-author-profile
deno check supabase/functions/get-explore-author-profile/index.ts
