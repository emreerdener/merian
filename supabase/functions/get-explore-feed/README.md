...
```sh
deno fmt --check supabase/functions/get-explore-feed
deno lint supabase/functions/get-explore-feed
deno check supabase/functions/get-explore-feed/index.ts
deno test --allow-env --allow-net supabase/functions/_tests/exploreFeedDb.test.ts
```
