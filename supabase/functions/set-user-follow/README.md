...
```sh
deno fmt --check supabase/functions/set-user-follow
deno lint supabase/functions/set-user-follow
deno check supabase/functions/set-user-follow/index.ts
deno test --allow-env --allow-net supabase/functions/_tests/userFollowsDb.test.ts supabase/functions/_tests/exploreNotificationsDb.test.ts
```
