...
assert_scope true pull_request "apps/ios/Merian/Core/Network/MerianNetworkClient.swift"
assert_scope true pull_request "apps/ios/Merian/Core/Network/Transport/PinnedNetworkTransport.swift"
assert_scope true pull_request "apps/ios/Merian/Core/Network/Auth/Coordinators/PurchaseIdentitySignOutWorkflow.swift"
...
assert_scope true pull_request "apps/ios/Merian/Core/Security/Consent/Services/ConsentRemoteService+Live.swift"
assert_scope true pull_request "apps/ios/Merian/Core/Security/PurchaseIdentity/Services/PurchasePrincipalRemoteService+Live.swift"
assert_scope true pull_request "apps/ios/Merian/Core/Security/ScanAdmissionManager.swift"
