...
struct OfflineQueueManagerTests {
    ...
    @Test func testEnqueueCaptureCreatesOfflineRecord() async throws {
        ...
        let descriptor = FetchDescriptor<MerianSchemaV8.OfflineQueuedScan>()
    ...
    @Test func testPurgeSoftDeletedRecords() async throws {
        ...
        let scan1 = MerianSchemaV8.OfflineQueuedScan(id: "1", isDeleted: true)
        let scan2 = MerianSchemaV8.OfflineQueuedScan(id: "2", isDeleted: false)
        ...
        let allScansDescriptor = FetchDescriptor<MerianSchemaV8.OfflineQueuedScan>()
    ...
    @Test func testEradicateScanQueuesLocalAndCloudTasks() async throws {
        ...
        let record = MerianSchemaV8.LocalScanRecord(
            id: scanId,
        ...
        let afterFetch = FetchDescriptor<MerianSchemaV8.LocalScanRecord>()
        ...
        let taskFetch = FetchDescriptor<MerianSchemaV8.PendingCloudDeletionTask>()
