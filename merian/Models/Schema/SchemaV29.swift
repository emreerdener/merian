...
//
// MARK: - Frozen LocalScanRecord snapshot for MerianSchemaV29
// Generated from ActiveSchema before imageQualityScore was added.
...
enum MerianSchemaV29: VersionedSchema {
    ...
    static var models: [any PersistentModel.Type] {
        [MerianSchemaV29.LocalScanRecord.self, MerianSchemaV29.OfflineQueuedScan.self,
         MerianSchemaV29.ScanCollection.self, MerianSchemaV29.PendingCloudDeletionTask.self]
    }

    typealias OfflineQueuedScan        = MerianSchemaV28.OfflineQueuedScan
    typealias PendingCloudDeletionTask = MerianSchemaV28.PendingCloudDeletionTask

    // ScanCollection redeclared so its inverse relationship points to V29.LocalScanRecord.
    @Model
