...
// Added: isDeleted on ScanCollection for soft-delete edge sync
enum MerianSchemaV14: VersionedSchema {
    ...
    typealias PendingCloudDeletionTask = MerianSchemaV13.PendingCloudDeletionTask
