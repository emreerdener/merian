...
// Added in V28: candidatesData — JSON-encoded [IdentificationCandidate] blob.
//
// MARK: - Frozen LocalScanRecord snapshot for MerianSchemaV28
// Generated from ActiveSchema before userIdentificationOverride / userConfirmedIdentification were added.
// DO NOT modify after committing. Checksums must remain stable forever.
enum MerianSchemaV28: VersionedSchema {
    static var versionIdentifier = Schema.Version(28, 0, 0)

    static var models: [any PersistentModel.Type] {
        [MerianSchemaV28.LocalScanRecord.self, MerianSchemaV28.OfflineQueuedScan.self,
         MerianSchemaV28.ScanCollection.self, MerianSchemaV28.PendingCloudDeletionTask.self]
    }

    typealias OfflineQueuedScan        = MerianSchemaV27.OfflineQueuedScan
    typealias PendingCloudDeletionTask = MerianSchemaV27.PendingCloudDeletionTask

    // ScanCollection redeclared so its inverse relationship points to V28.LocalScanRecord.
    @Model
