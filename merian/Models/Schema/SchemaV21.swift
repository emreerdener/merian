...
// Changed: removed globalDistributionRegionsJson — no longer written or read by the application.
// Distribution data is communicated exclusively through the GBIF tile overlay (gbifTaxonKey).
enum MerianSchemaV21: VersionedSchema {
    ...
    // ScanCollection redeclared so its inverse relationship points to V21.LocalScanRecord.
    @Model
