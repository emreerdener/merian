...
Merian requires strict synchronization between the TypeScript (`supabase/functions/`) backend and the Swift natively parsed environment. This workflow guarantees that no regressions occur during an Edge deploy.
