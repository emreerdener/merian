...
shared Field Chat prompt rules and native reply request/parser; admission, daily
usage, response helpers, and generated identity remain at the shared root. The
table below groups the remaining root TypeScript modules by their current
purpose; it does not claim these are already separate directories. Shared media
and authorization helpers have consumers across several endpoint groups.
...
| Field Chat                                          | [fieldChatDailyUsage.ts](./_shared/fieldChatDailyUsage.ts), [fieldChatDeploymentIdentity.ts](./_shared/fieldChatDeploymentIdentity.ts), [fieldChatReservation.ts](./_shared/fieldChatReservation.ts), [fieldChatResponse.ts](./_shared/fieldChatResponse.ts)                                                                                                                                                                                                                                                               |
