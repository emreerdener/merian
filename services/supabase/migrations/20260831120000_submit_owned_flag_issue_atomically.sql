-- Keep legacy identification-dispute writes atomic and owner-bound.
-- Public Explore content reports use explore_post_reports instead.
...
BEGIN
    ...
    RETURNING id INTO flagged_review_id;

    IF flagged_review_id IS NULL THEN
