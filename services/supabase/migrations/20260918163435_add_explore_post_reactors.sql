-- Detail-only public reactor identities. Likes participate as the canonical red heart.
CREATE FUNCTION public.get_explore_post_reactors(
...
VALUES ('service_role','public.get_explore_post_reactors(uuid,uuid,uuid)',
    'Authenticated detail-only reactor identities, filtered before counting and pagination');
