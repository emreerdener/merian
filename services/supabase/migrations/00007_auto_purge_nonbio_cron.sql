...
-- 2. Clean previous schedules for idempotency
DO $$
BEGIN
    PERFORM cron.unschedule('auto_purge_nonbio_daily');
...
-- Executing every day at 03:00 UTC
SELECT cron.schedule(
    'auto_purge_nonbio_daily',
    '0 3 * * *',
    $$
    DO $job$
    DECLARE
    ...
    BEGIN
        ...
        edge_endpoint := project_url || '/functions/v1/auto-purge-nonbio';
