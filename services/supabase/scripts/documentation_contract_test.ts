...
Deno.test("joined scan reliability documentation preserves critical contracts", async () => {
  ...
  for (
    const fragment of [
      ...
      "Final Deno discovery run: 1,365 passed, 0 failed",
      "optional PostgreSQL integration bodies self-skipped because this sandbox denied localhost TCP",
      "177 assertions passed across 27 migration contract files",
      ...
      "new 24-assertion rollback-only catalog",
      ...
      "all 26 current files must pass",
