...
Deno.test("production deploy proves critical scan RPC readiness without mutation", async () => {
  ...
  for (
    const requiredFragment of [
      ...
      "Critical service RPC smoke names and payloads are misaligned.",
