...
async function validateAPIContracts() {
  ...
  const swiftPath = "../../../apps/ios/Merian/Core/AI/InferenceEdgeDTOs.swift";
  ...
  try {
    ...
    console.error(`❌ File read failed. Ensure you are running this from services/supabase/scripts/\n${e}`);
    Deno.exit(1);
  }
