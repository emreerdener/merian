...
- Fixed video Explore sharing so composer-selected video clips publish from the captured-media manifest and failed media snapshots no longer leave the Share sheet showing a phantom Explore post.
