...
- **[`/features-and-hardware/24-explore-bottom-menu.md`](./features-and-hardware/24-explore-bottom-menu.md)** — Explore root pager, Community identification queue, bottom menu, Dictionary catalog, and simulator-only personal Tree of Life canvas routing/data boundaries.
