...
- **[`/features-and-hardware/24-explore-bottom-menu.md`](./features-and-hardware/24-explore-bottom-menu.md)** — Explore root pager, bottom menu, Dictionary catalog, and backend-backed personal Tree of Life canvas routing/data boundaries.
