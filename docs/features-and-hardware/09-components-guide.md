...
- **Accessibility boundary**: The Button combines icon and text children into one explicitly labeled accessibility element. Callers keep the composed badge at intrinsic size; no decorative child may use `GeometryReader` or horizontal offsets.
