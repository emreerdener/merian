...
## 6. Global Features/_Shared/ Primitives

To brutally eliminate SwiftUI structural redundancy (ZStacks, Confirmation Dialogs, Repetitive Icons), core application placeholders are hoisted totally outside localized feature boundaries into `merian/Features/_Shared/`:
