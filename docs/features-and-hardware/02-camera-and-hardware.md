...
- Triggers `VUIHint` prompts across the viewfinder (`"Too dark"`, `"Move closer"`) without any network calls. Evaluates an optional `distance: Float?` constraint for subjects over 2.5 meters.
