...
To continuously refine the `gemini-2.5-flash` model and build a high-quality human-verified dataset ("Golden Dataset"), Merian allows users to flag incorrect taxonomy outputs directly from the `InsightSheetView`:
