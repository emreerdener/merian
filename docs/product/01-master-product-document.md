...
| Current schema is V45.                                    | Current SwiftData alias is `MerianSchemaV51`; `MerianSchemaV50` remains the immutable released-store fixture and V51 makes preferred species names account-scoped. |
