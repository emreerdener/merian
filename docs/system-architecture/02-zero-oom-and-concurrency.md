...
file URLs through `MediaPreparationActor` before constructing any `UIImage`.
The external import store copies the source file but never decodes it; ImageIO
