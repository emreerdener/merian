...
```json
{
  ...
  "// Present when confidence_score < diagnosticTrigger (0.96 Flash / 0.85 Pro == strong threshold); server strips to null for Strong match scans only. See identify/thresholds.ts.": "",
  "candidates": [
