...
The error/result distinction is explicit and copy-independent. See the
[live scan connectivity handoff incident](../incidents/2026-08-live-scan-connectivity-handoff-gap.md)
...
success is not release evidence, and
...
current connectivity follow-up adds the companion live-Insight-to-queue case
and requires both names as one exact result set. These descendants and the
...
and the current-SHA archive together.
