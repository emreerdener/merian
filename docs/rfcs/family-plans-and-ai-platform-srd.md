...
| iOS entitlement/session fencing         | [RevenueCat ownership](../../apps/ios/Merian/Core/Security/RevenueCat/README.md), [RevenueCatManager](../../apps/ios/Merian/Core/Security/RevenueCatManager.swift), [EntitlementManager](../../apps/ios/Merian/Core/Security/EntitlementManager.swift), and [PurchasePrincipalResolver](../../apps/ios/Merian/Core/Security/PurchasePrincipalResolver.swift). |
