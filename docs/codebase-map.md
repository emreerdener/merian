...
| Marketing/home placeholder | `apps/web/app/page.tsx`, `apps/web/lib/exploreMedia.ts`                                                                                                                                       | Lightweight Merian landing surface with a public Explore grid that prefers visual heroes, then persisted audio spectrogram posters. |
| Explore share page         | `apps/web/app/explore/post/[postId]/page.tsx`, `apps/web/components/ExploreAudioPlayers.tsx`, `apps/web/lib/exploreMedia.ts`                                                                  | Server-rendered public Explore post page with canonical, Open Graph, and Twitter metadata plus spectrogram-backed, user-initiated audio playback. |
