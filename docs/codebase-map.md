...
missing source roots, and runtime numeric bounds. `latencyDb.ts` owns the atomic
ingestion-setup and dictionary-hydration calls; `subjectClassification.ts` is
