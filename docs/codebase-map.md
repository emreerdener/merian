...
| Utilities                | `apps/ios/Merian/Core/Utilities/`               | App lifecycle, framework-to-main-actor publisher bridge, config constants, field-notes reconciliation, errors, and date and trim-to-non-empty helpers. Shared visual loading and UIKit share presentation live in `Core/UI`; shared bounded image downsampling lives in `Core/Data/Images`; Capture-only focus detection and size estimation live in `Features/Capture/Shared/Services` and `Features/Capture/Submission/Services`. Typed settings, small keyed stores, and the exact defaults-key registry live in `Core/Preferences`; durable species preferences live in `Core/Data/SpeciesPreferences`; account-deletion recovery and the secure-key registry live in `Core/Security`; and typed event/route coordination lives in `Core/Routing`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
...
shared navigation stack and Identify/Species selection. The Activity route's
