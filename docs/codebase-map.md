...
`GITHUB_SHA`, and `scripts/export-ios-release.sh` refuses an archive that does
not match the clean checked-out release source. Fingerprinting rejects tracked
