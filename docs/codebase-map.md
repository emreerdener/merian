...
| Security       | `apps/ios/Merian/Core/Security/`           | Circuit breaker, device identity, paid RevenueCat state, current-launch versioned complimentary entitlement, append-only versioned adult/Terms/Gemini/PostHog consent ledger and sync, causal provider append with stale-grant rejection and deny-wins revocation rebasing, all-version provider-head authorization, atomic verified ledger-file storage, Keychain withdrawal journal, and social guard. The canonical hold is [`production-consent-readiness-2026-08-03.md`](./legal/production-consent-readiness-2026-08-03.md).                                                                 |
