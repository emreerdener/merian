...
| UI             | `apps/ios/Merian/Core/UI/`                 | Shared controls, tab bar, media mode toggle, cross-feature scan-thumbnail projection/rendering with injected loader closures, generic empty-state presentation, domain-neutral goal progress ring, slide-to-confirm, reusable modifiers/theme, typed `ToastPayload`, and the bounded DI-owned milestone presenter/foreground-host system.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
