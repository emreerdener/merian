...
| Media          | `apps/ios/Merian/Core/Media/`              | Shared bounded local-media processing, including `InferenceAudioPreparer` for secure historical-reference materialization and canonical queue/refinement WAV sidecars, adaptive audio boost, normalized spectrogram seeking/display-progress policy, and `MediaPlaybackObservation`. The observation owner removes exact AVPlayer KVO/notification/periodic-time tokens and generation-fences late callbacks from replaced players.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
