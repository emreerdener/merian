...
| Data/Images    | `apps/ios/Merian/Core/Data/Images/`        | File-backed still-image preparation, archive rescue, photo-library access, thumbnails, RAM caching, request coalescing, and cancellation-aware bounded local/remote ImageIO decoding.                                                         |
