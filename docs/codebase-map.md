...
| Scan | `apps/ios/Merian/Features/Capture/Scan/` | Camera preview, focus/zoom gestures, cropper, flash, photo picker, viewfinder hints, Pro video capture, sampled-frame/WAV extraction, and compressed playback clip staging. |
