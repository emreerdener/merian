...
| Onboarding         | `apps/ios/Merian/Features/Onboarding/`                                                                                                 | Product-area-first permission and consent flow. `Shell/` owns the root view and state machine, `Steps/` owns Welcome/Camera/Location and the final adult/Terms/Gemini/optional-analytics surface plus shared chrome, and `Permissions/` owns native permission delegates. Existing users missing current required evidence route directly to Ready.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
...
| Security       | `apps/ios/Merian/Core/Security/`           | Circuit breaker, device identity, paid RevenueCat state, current-launch versioned complimentary entitlement, append-only versioned adult/Terms/Gemini/PostHog consent ledger and sync, and social guard. The canonical hold is [`production-consent-readiness-2026-08-03.md`](./legal/production-consent-readiness-2026-08-03.md).                                                                 |
