...
| Explore | `apps/ios/Merian/Features/Explore/` | Public feed/map, post detail, composer common-name selection, hashtag publishing/suggestions and tagged-post collections, comments, notifications, author profiles, username-aware display labels, follow/like/comment/reaction actions, and widget snapshot writing. |
