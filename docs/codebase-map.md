...
- `Core/Data/Database/CoreDataIntegrationArchitectureTests.swift` freezes the
  ...
  finalization, goal hints, queue maintenance, cloud deletion, and historical
  reconciliation.
