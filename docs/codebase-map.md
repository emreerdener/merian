...
| Media          | `apps/ios/Merian/Core/Media/`              | Shared bounded local-media processing, including adaptive audio boost reused by Explore and private scan Insights without modifying source recordings.                                  |
