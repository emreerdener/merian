...
| Local visual-analysis DI     | `apps/ios/Merian/Core/AppDIContainer.swift`, `apps/ios/Merian/Core/AI/LocalVisualAnalysis.swift`                                                                 | Owns the live Apple Vision classifier, no-op Xcode 26.6 Foundation visual-cue provider, and runtime eligibility checker injected into `InferenceEngine`. The bounded image and all local classifications/cues remain ephemeral.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
...
| -------------- | ------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| AI             | `apps/ios/Merian/Core/AI/`                 | `InferenceEngine`, edge DTOs, parse/save actor, on-device viewfinder intelligence, and `LocalVisualAnalysis` protocols/policies for bounded Vision classification, progressive phrases, and future Foundation visual cues.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
...
generic → Vision category → validated visible trait only after explicit badge
...
its exact durable row without presenting a synthetic error.
