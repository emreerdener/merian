...
| Identification review DI      | `apps/ios/Merian/Core/AppDIContainer.swift`, `apps/ios/Merian/Core/Network/Inference/InferenceIdentificationReviewService.swift`, `apps/ios/Merian/Core/AI/Inference/Services/InferenceReviewSnapshotService.swift` | AppDI owns the immutable typed service for exact-name Species Dictionary reads and the owned-scan identification-review RPC, plus the bounded throwing SwiftData snapshot read used before confirmation and reset. Network operations retain their account-work lease; an unreadable local store fails closed before the engine changes review presentation, action generations, local state, or cloud state. `InferenceEngine` retains sequencing and post-success effects without issuing Supabase queries or silently discarding a fetch failure.                                                                                                                                                                                                                                          |
...
Staging, Shell, Submission, and Core Data Offline Sync suites own state, toolbar
...
| ------------------------ | ----------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| AI                       | `apps/ios/Merian/Core/AI/`                      | `InferenceEngine` observable orchestration and exact presentation authority; `Inference/Request` injected visual/nonvisual request mapping, staged-video upload, and provider dispatch; `Inference/Result` injected live parse/save input normalization, typed persisted/no-record/rejected outcomes, tier confidence presentation bands, and synchronous persisted-replacement/metadata safety before repository deletion; `Inference/Recovery` stateless failure classification, modality-specific telemetry/circuit/feedback decisions, and typed error presentation, plus the lookalike-cache reset policy, with synchronous exact-owner effects retained by the engine; `Inference/Hydration` replaceable live/historical/identification-review task ownership, Auth draining, bounded request histories, persisted enrichment TTL, temporary backoff, and structured Wikipedia/enrichment/GBIF child work; `Inference/State` bounded write/review sequencing and Auth fencing; `Inference/LocalAnalysis` contained ephemeral model/cadence lifetime plus split Vision, bounded-image, deterministic-trait, phrase, cadence, and future Foundation-cue policies; generated Edge DTOs; the stateless shared response-preparation service; the foreground parse/save actor; and on-device viewfinder intelligence.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
...
five remaining production files above 600 lines: `InferenceEngine.swift`,
`ExploreAPIModels.swift`, `FieldTripAPIModels.swift`, `SupabaseManager.swift`,
and `ConsentManager.swift`.
...
- `Core/Architecture/CoreIntegrationArchitectureTests.swift` freezes the Core
  root/domain and README inventories, the explicit five-file residual size
