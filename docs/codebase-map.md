...
| ------------------ | -------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Capture            | `apps/ios/Merian/Features/Capture/`                                                                                                    | Product-area-first capture surface. `Shell/` owns the three-page Scan/Record/Describe pager, fixed overlay chrome, sheets, routing, root view model, and pending Photos-import handoff; `Staging/` owns mixed-media staging UI and models; `Submission/` owns shared live/offline analysis paths; `Refinement/` is reserved for reanalysis helpers; `Shared/` holds cross-mode capture primitives.                                                                                                                                                                                                                                                                                          |
...
- Capture workspace staging, camera analysis, Photos document-import durability
  and EXIF handling, audio/describe helpers, and queued handoff flows.
