...
| Dependency container         | `apps/ios/Merian/Core/AppDIContainer.swift`                                                                 | Owns the production dependency graph, including one typed invalidation bus and one route coordinator; injects observable hardware, AI, sync, network, analytics, security, settings, profile, goal-context, and route state through SwiftUI `@Environment`. Preview graphs remain isolated from production route/auth binding.                                                                                                                                                                                                                  |
