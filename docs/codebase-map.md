...
`20260728232000_ensure_scan_user_profile.sql`, and
`20260728233000_recover_identity_merge_interrupted_scans.sql`. Together with
...
standalone audio, and owner-scope Explore restoration.
